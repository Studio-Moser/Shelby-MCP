...
assert.match(workflow, /github\.ref == 'refs\/tags\/v0\.4\.0'/);
assert.doesNotMatch(workflow, /--prerelease|v0\.4\.0-/);
assert.match(workflow, /--mcpb aarch64-apple-darwin=/);
assert.match(workflow, /--mcpb x86_64-pc-windows-msvc=/);
